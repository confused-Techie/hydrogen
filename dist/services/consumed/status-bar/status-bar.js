...
const status_bar_component_1 = __importDefault(
  require("./status-bar-component")
);
...
class StatusBarConsumer {
  addStatusBar(store, statusBar, handleKernelCommand) {
    ...
    (0, utils_1.reactFactory)(
      react_1.default.createElement(status_bar_component_1.default, {
        store: store,
        onClick: onClick,
      }),
      statusBarElement
  ...
  showKernelCommands(store, handleKernelCommand) {
    ...
    if (!signalListView) {
      signalListView = new signal_list_view_1.default(
        store,
        handleKernelCommand
      );
