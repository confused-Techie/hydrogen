...
function activate() {
    ...
    store_1.default.subscriptions.add(new atom_1.Disposable(() => { // Destroy any Panes when the package is deactivated.
...
function handleKernelCommand({ command, payload }, { kernel, markers }) { // TODO payload is not used!
